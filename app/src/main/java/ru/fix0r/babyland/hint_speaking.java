 ...
 */
public class hint_speaking extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.learn_hint_speaking);

        Typeface mytypeface = Typeface.createFromAsset(this.getAssets(),"wiguru2.ttf");

       ((TextView) findViewById(R.id.textView12)).setTypeface(mytypeface);
        //((TextView) findViewById(R.id.textView8)).setTypeface(mytypeface);

        butOk = (ImageView) findViewById(R.id.imageView15);
