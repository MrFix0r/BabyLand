 ...
 */
public class hint_catch extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_hint_catch);

        Typeface mytypeface = Typeface.createFromAsset(this.getAssets(),"wiguru2.ttf");

        ((TextView) findViewById(R.id.textView15)).setTypeface(mytypeface);
        //((TextView) findViewById(R.id.textView8)).setTypeface(mytypeface);

        butOk = (ImageView) findViewById(R.id.imageView17);
