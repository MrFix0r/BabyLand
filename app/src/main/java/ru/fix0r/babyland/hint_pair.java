 ...
 */
public class hint_pair extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.play_hint_pair);

        Typeface mytypeface = Typeface.createFromAsset(this.getAssets(),"wiguru2.ttf");

        ((TextView) findViewById(R.id.textView14)).setTypeface(mytypeface);
        //((TextView) findViewById(R.id.textView8)).setTypeface(mytypeface);

        butOk = (ImageView) findViewById(R.id.imageView19);
